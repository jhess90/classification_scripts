...
for(block_name in file_list){
  ...
  if(ind == 1){
    ...
    M1_win_r_br <- rbind(M1_win_r_br,M1_sm_sig_p_r_bin_br)
    M1_win_r_ar <- rbind(M1_win_r_ar,M1_sm_sig_p_r_bin_ar)
    M1_win_p_ac <- rbind(M1_win_p_ac,M1_sm_sig_p_p_bin_ac)
    M1_win_p_br <- rbind(M1_win_p_br,M1_sm_sig_p_p_bin_br)
    M1_win_p_ar <- rbind(M1_win_p_ar,M1_sm_sig_p_p_bin_ar)
    M1_win_r_s_ac <- rbind(M1_win_r_s_ac,M1_sm_sig_p_r_s_bin_ac)
    M1_win_r_s_br <- rbind(M1_win_r_s_br,M1_sm_sig_p_r_s_bin_br)
    M1_win_r_s_ar <- rbind(M1_win_r_s_ar,M1_sm_sig_p_r_s_bin_ar)
    M1_win_p_f_ac <- rbind(M1_win_p_f_ac,M1_sm_sig_p_p_f_bin_ac)
    M1_win_p_f_br <- rbind(M1_win_p_f_br,M1_sm_sig_p_p_f_bin_br)
    M1_win_p_f_ar <- rbind(M1_win_p_f_ar,M1_sm_sig_p_p_f_bin_ar)
    M1_win_res_ac <- rbind(M1_win_res_ac,M1_sm_sig_p_outcome_levels_ac)
    M1_win_res_br <- rbind(M1_win_res_br,M1_sm_sig_p_outcome_levels_br)
    M1_win_res_ar <- rbind(M1_win_res_ar,M1_sm_sig_p_outcome_levels_ar)
    
    S1_win_r_ac <- rbind(S1_win_r_ac,S1_sm_sig_p_r_bin_ac)
    S1_win_r_br <- rbind(S1_win_r_br,S1_sm_sig_p_r_bin_br)
    S1_win_r_ar <- rbind(S1_win_r_ar,S1_sm_sig_p_r_bin_ar)
    S1_win_p_ac <- rbind(S1_win_p_ac,S1_sm_sig_p_p_bin_ac)
    S1_win_p_br <- rbind(S1_win_p_br,S1_sm_sig_p_p_bin_br)
    S1_win_p_ar <- rbind(S1_win_p_ar,S1_sm_sig_p_p_bin_ar)
    S1_win_r_s_ac <- rbind(S1_win_r_s_ac,S1_sm_sig_p_r_s_bin_ac)
    S1_win_r_s_br <- rbind(S1_win_r_s_br,S1_sm_sig_p_r_s_bin_br)
    S1_win_r_s_ar <- rbind(S1_win_r_s_ar,S1_sm_sig_p_r_s_bin_ar)
    S1_win_p_f_ac <- rbind(S1_win_p_f_ac,S1_sm_sig_p_p_f_bin_ac)
    S1_win_p_f_br <- rbind(S1_win_p_f_br,S1_sm_sig_p_p_f_bin_br)
    S1_win_p_f_ar <- rbind(S1_win_p_f_ar,S1_sm_sig_p_p_f_bin_ar)
    S1_win_res_ac <- rbind(S1_win_res_ac,S1_sm_sig_p_outcome_levels_ac)
    S1_win_res_br <- rbind(S1_win_res_br,S1_sm_sig_p_outcome_levels_br)
    S1_win_res_ar <- rbind(S1_win_res_ar,S1_sm_sig_p_outcome_levels_ar)
    
    PmD_win_r_ac <- rbind(PmD_win_r_ac,PmD_sm_sig_p_r_bin_ac)
    PmD_win_r_br <- rbind(PmD_win_r_br,PmD_sm_sig_p_r_bin_br)
    PmD_win_r_ar <- rbind(PmD_win_r_ar,PmD_sm_sig_p_r_bin_ar)
    PmD_win_p_ac <- rbind(PmD_win_p_ac,PmD_sm_sig_p_p_bin_ac)
    PmD_win_p_br <- rbind(PmD_win_p_br,PmD_sm_sig_p_p_bin_br)
    PmD_win_p_ar <- rbind(PmD_win_p_ar,PmD_sm_sig_p_p_bin_ar)
    PmD_win_r_s_ac <- rbind(PmD_win_r_s_ac,PmD_sm_sig_p_r_s_bin_ac)
    PmD_win_r_s_br <- rbind(PmD_win_r_s_br,PmD_sm_sig_p_r_s_bin_br)
    PmD_win_r_s_ar <- rbind(PmD_win_r_s_ar,PmD_sm_sig_p_r_s_bin_ar)
    PmD_win_p_f_ac <- rbind(PmD_win_p_f_ac,PmD_sm_sig_p_p_f_bin_ac)
    PmD_win_p_f_br <- rbind(PmD_win_p_f_br,PmD_sm_sig_p_p_f_bin_br)
    PmD_win_p_f_ar <- rbind(PmD_win_p_f_ar,PmD_sm_sig_p_p_f_bin_ar)
    PmD_win_res_ac <- rbind(PmD_win_res_ac,PmD_sm_sig_p_outcome_levels_ac)
    PmD_win_res_br <- rbind(PmD_win_res_br,PmD_sm_sig_p_outcome_levels_br)
    PmD_win_res_ar <- rbind(PmD_win_res_ar,PmD_sm_sig_p_outcome_levels_ar)
...
for(region_index in 1:length(region_list)){
  ...
  #punishment
  png(paste(region_list[region_index],'_p_sig_diffs_total_perc.png',sep=""),width=8,height=6,units="in",res=500)
  ...
  if(dim(num_inc)[1] != 4){
    ...
    plt <- ggplot() + geom_bar(data=both_num,aes(y=value,x=level,fill=direction),stat="identity",position="stack",show.legend=F) + facet_grid(~window)
    plt <- plt + theme_bw() + scale_fill_manual(values=c("lightcoral","royalblue")) + labs(title=paste("Region: ",region_list[region_index],'\nTotal units: ',total_unit_num,sep=""),x='Punishment Level',y='Percent Significant')
    plt <- plt + theme_classic() + theme(panel.grid.major.y=element_line(color='lightgrey',size=0.25) ,strip.text=element_text(size=16),plot.title=element_text(size=16),axis.title=element_text(size=16),axis.text=element_text(size=12))
  ...
  #rx outcome
  png(paste(region_list[region_index],'_rx_outcome_sig_diffs_total_perc.png',sep=""),width=8,height=6,units="in",res=500)
  ...
  plt <- ggplot() + geom_bar(data=both_num,aes(y=value,x=level,fill=direction),stat="identity",position="stack",show.legend=F) + facet_grid(~window)
  plt <- plt + theme_bw() + scale_fill_manual(values=c("lightcoral","royalblue")) + labs(title=paste("Region: ",region_list[region_index],'\nTotal units: ',total_unit_num,sep=""),x='Reward and Outcome',y='Percent Significant')
  plt <- plt + theme_classic() + theme(panel.grid.major.y=element_line(color='lightgrey',size=0.25) ,strip.text=element_text(size=16),plot.title=element_text(size=16),axis.title=element_text(size=16),axis.text=element_text(size=12))
  ...
  #px outcome
  png(paste(region_list[region_index],'_px_outcome_sig_diffs_total_perc.png',sep=""),width=8,height=6,units="in",res=500)
  ...
  plt <- ggplot() + geom_bar(data=both_num,aes(y=value,x=level,fill=direction),stat="identity",position="stack",show.legend=F) + facet_grid(~window)
  plt <- plt + theme_bw() + scale_fill_manual(values=c("lightcoral","royalblue")) + labs(title=paste("Region: ",region_list[region_index],'\nTotal units: ',total_unit_num,sep=""),x='Punishment and Outcome',y='Percent Significant')
  plt <- plt + theme_classic() + theme(panel.grid.major.y=element_line(color='lightgrey',size=0.25) ,strip.text=element_text(size=16),plot.title=element_text(size=16),axis.title=element_text(size=16),axis.text=element_text(size=12))
  ...
  #r binary
  png(paste(region_list[region_index],'_r_binary_sig_diffs_total_perc.png',sep=""),width=8,height=6,units="in",res=500)
  ...
  #px outcome
  png(paste(region_list[region_index],'_p_binary_sig_diffs_total_perc.png',sep=""),width=8,height=6,units="in",res=500)
  ...
  #res outcome
  png(paste(region_list[region_index],'_res_outcome_sig_diffs_total_perc.png',sep=""),width=8,height=6,units="in",res=500)
  ...
  plt <- ggplot() + geom_bar(data=both_num,aes(y=value,x=level,fill=direction),stat="identity",position="stack",show.legend=F) + facet_grid(~window)
  plt <- plt + theme_bw() + scale_fill_manual(values=c("lightcoral","royalblue")) + labs(title=paste("Region: ",region_list[region_index],'\nTotal units: ',total_unit_num,sep=""),x='Result',y='Percent Significant')
  plt <- plt + theme_classic() + theme(panel.grid.major.y=element_line(color='lightgrey',size=0.25) ,strip.text=element_text(size=16),plot.title=element_text(size=16),axis.title=element_text(size=16),axis.text=element_text(size=12))
  ...
  #comb
  png(paste(region_list[region_index],'_comb_sig_diffs_total_perc.png',sep=""),width=8,height=6,units="in",res=500)
  ...
  plt <- ggplot() + geom_bar(data=both_num,aes(y=value,x=level,fill=direction),stat="identity",position="stack",show.legend=F) + facet_grid(~window)
  plt <- plt + theme_bw() + scale_fill_manual(values=c("lightcoral","royalblue")) + labs(title=paste("Region: ",region_list[region_index],'\nTotal units: ',total_unit_num,sep=""),x='Combination',y='Percent Significant')
  ...
  #comb outcome succ
  png(paste(region_list[region_index],'_comb_outcome_succ_sig_diffs_total_perc.png',sep=""),width=8,height=6,units="in",res=500)
  ...
  num_inc <- cbind(num_inc[,1],num_inc[,5])
  num_inc <- num_inc / total_unit_num
  rownames(num_inc) <- c('r0p0s','rxp0s','r0pxs','rxpxs')
  colnames(num_inc) <- window_names
  num_inc_melt <- melt(num_inc,varnames=c('level','window'))
  num_inc_melt$direction <- 'inc'
  ...
  num_dec <- cbind(num_dec[,1],num_dec[,5])
  num_dec <- num_dec / total_unit_num
  rownames(num_dec) <- c('r0p0s','rxp0s','r0pxs','rxpxs')
  colnames(num_dec) <- window_names
  num_dec_melt <- melt(num_dec,varnames=c('level','window'))
  num_dec_melt$direction <- 'dec'
  ...
  #comb outcome
  png(paste(region_list[region_index],'_comb_outcome_sig_diffs_total_perc.png',sep=""),width=8,height=6,units="in",res=500)
  ...
  #reward outcome
  png(paste(region_list[region_index],'_r_outcome_sig_diffs_total_perc.png',sep=""),width=8,height=6,units="in",res=500)
  ...
  if(length(num_inc) > 0){
    if(dim(num_inc)[1] != 8){
      ...
      plt <- ggplot() + geom_bar(data=both_num,aes(y=value,x=level,fill=direction),stat="identity",position="stack",show.legend=F) + facet_grid(~window)
      plt <- plt + theme_bw() + scale_fill_manual(values=c("lightcoral","royalblue")) + labs(title=paste("Region: ",region_list[region_index],'\nTotal units: ',total_unit_num,sep=""),x='Reward Level and Outcome',y='Percent Significant')
      plt <- plt + theme(axis.text.x = element_text(angle=45,hjust=1))
      plt <- plt + theme_classic() + theme(panel.grid.major.y=element_line(color='lightgrey',size=0.25) ,strip.text=element_text(size=16),plot.title=element_text(size=16),axis.title=element_text(size=16),axis.text=element_text(size=12))
  ...
  #punishment outcome
  png(paste(region_list[region_index],'_p_outcome_sig_diffs_total_perc.png',sep=""),width=8,height=6,units="in",res=500)
  ...
  if(length(num_inc) > 0){
    if(dim(num_inc)[1] != 8){
      ...
      plt <- ggplot() + geom_bar(data=both_num,aes(y=value,x=level,fill=direction),stat="identity",position="stack",show.legend=F) + facet_grid(~window)
      plt <- plt + theme_bw() + scale_fill_manual(values=c("lightcoral","royalblue")) + labs(title=paste("Region: ",region_list[region_index],'\nTotal units: ',total_unit_num,sep=""),x='Punishment Level and Outcome',y='Percent Significant')
      plt <- plt + theme(axis.text.x = element_text(angle=45,hjust=1))
      plt <- plt + theme_classic() + theme(panel.grid.major.y=element_line(color='lightgrey',size=0.25) ,strip.text=element_text(size=16),plot.title=element_text(size=16),axis.title=element_text(size=16),axis.text=element_text(size=12))
