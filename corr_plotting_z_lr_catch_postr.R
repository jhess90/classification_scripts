...
for (region_index in 1:length(region_list)){
  ...
  # 
  # png(paste('corr_tb_r_',region_list[region_index],'_lr_pr.png',sep=""),width=8,height=6,units="in",res=500)
  # 
  ...
  # 
  # png(paste('corr_tb_p_',region_list[region_index],'_lr_pr.png',sep=""),width=8,height=6,units="in",res=500)
  # 
  ...
  # 
  # png(paste('corr_tb_res_',region_list[region_index],'_lr_pr.png',sep=""),width=8,height=6,units="in",res=500)
  # 
  ...
  # 
  # png(paste('corr_tb_v_',region_list[region_index],'_lr_pr.png',sep=""),width=8,height=6,units="in",res=500)
  # 
  ...
  # 
  # png(paste('corr_tb_m_',region_list[region_index],'_lr_pr.png',sep=""),width=8,height=6,units="in",res=500)
  # 
  ...
  for (i in 1:units_to_plot){
    ...
    png(paste('corr_r_t',i,'_',region_list[region_index],'_lr_pr.png',sep=""),width=8,height=6,units="in",res=500)
    ...
    ##
    png(paste('corr_r_sf_t',i,'_',region_list[region_index],'_lr_pr.png',sep=""),width=8,height=6,units="in",res=500)
    ...
    #############
    png(paste('corr_p_t',i,'_',region_list[region_index],'_lr_pr.png',sep=""),width=8,height=6,units="in",res=500)
    ...
    #
    png(paste('corr_p_sf_t',i,'_',region_list[region_index],'_lr_pr.png',sep=""),width=8,height=6,units="in",res=500)
    ...
    ##########
    png(paste('corr_res_t',i,'_',region_list[region_index],'_lr_pr.png',sep=""),width=8,height=6,units="in",res=500)
    ...
    ##########
    png(paste('corr_v_t',i,'_',region_list[region_index],'_lr_pr.png',sep=""),width=8,height=6,units="in",res=500)
    ...
    #
    png(paste('corr_v_sf_t',i,'_',region_list[region_index],'_lr_pr.png',sep=""),width=8,height=6,units="in",res=500)
    ...
    ##########
    png(paste('corr_m_t',i,'_',region_list[region_index],'_lr_pr.png',sep=""),width=8,height=6,units="in",res=500)
    ...
    #
    png(paste('corr_m_sf_t',i,'_',region_list[region_index],'_lr_pr.png',sep=""),width=8,height=6,units="in",res=500)
    ...
    ##############
    ##
    png(paste('corr_catch_mult_r_t',i,'_',region_list[region_index],'_lr_pr.png',sep=""),width=8,height=6,units="in",res=500)
    ...
    #p levels catch
    png(paste('corr_catch_mult_p_t',i,'_',region_list[region_index],'_lr_pr.png',sep=""),width=8,height=6,units="in",res=500)
    ...
    ## catch bin r
    png(paste('corr_catch_bin_r_t',i,'_',region_list[region_index],'_lr_pr.png',sep=""),width=8,height=6,units="in",res=500)
    ...
    ## catch bin p
    png(paste('corr_catch_bin_p_t',i,'_',region_list[region_index],'_lr_pr.png',sep=""),width=8,height=6,units="in",res=500)
  ...
  for (i in 1:units_to_plot){
    ...
    ##########
    png(paste('corr_r_b',i,'_',region_list[region_index],'_lr_pr.png',sep=""),width=8,height=6,units="in",res=500)
    ...
    ##
    png(paste('corr_r_sf_b',i,'_',region_list[region_index],'_lr_pr.png',sep=""),width=8,height=6,units="in",res=500)
    ...
    #############
    png(paste('corr_p_b',i,'_',region_list[region_index],'_lr_pr.png',sep=""),width=8,height=6,units="in",res=500)
    ...
    #
    png(paste('corr_p_sf_b',i,'_',region_list[region_index],'_lr_pr.png',sep=""),width=8,height=6,units="in",res=500)
    ...
    ##########
    png(paste('corr_res_b',i,'_',region_list[region_index],'_lr_pr.png',sep=""),width=8,height=6,units="in",res=500)
    ...
    ##########
    png(paste('corr_v_b',i,'_',region_list[region_index],'_lr_pr.png',sep=""),width=8,height=6,units="in",res=500)
    ...
    graphics.off()
    #
    png(paste('corr_v_sf_b',i,'_',region_list[region_index],'_lr_pr.png',sep=""),width=8,height=6,units="in",res=500)
    ...
    ##########
    png(paste('corr_m_b',i,'_',region_list[region_index],'_lr_pr.png',sep=""),width=8,height=6,units="in",res=500)
    ...
    #
    png(paste('corr_m_sf_b',i,'_',region_list[region_index],'_lr_pr.png',sep=""),width=8,height=6,units="in",res=500)
    ...
    ##
    png(paste('corr_catch_mult_r_b',i,'_',region_list[region_index],'_lr_pr.png',sep=""),width=8,height=6,units="in",res=500)
    ...
    #p levels catch
    png(paste('corr_catch_mult_p_b',i,'_',region_list[region_index],'_lr_pr.png',sep=""),width=8,height=6,units="in",res=500)
    ...
    ## catch bin r
    png(paste('corr_catch_bin_r_b',i,'_',region_list[region_index],'_lr_pr.png',sep=""),width=8,height=6,units="in",res=500)
    ...
    ## catch bin p
    png(paste('corr_catch_bin_p_b',i,'_',region_list[region_index],'_lr_pr.png',sep=""),width=8,height=6,units="in",res=500)
  ...
  png(paste('corr_r_t_total_',region_list[region_index],'_lr_pr.png',sep=""),width=8,height=6,units="in",res=500)
  ...
  ##
  png(paste('corr_r_sf_t_total_',region_list[region_index],'_lr_pr.png',sep=""),width=8,height=6,units="in",res=500)
  ...
  #############
  png(paste('corr_p_t_total_',region_list[region_index],'_lr_pr.png',sep=""),width=8,height=6,units="in",res=500)
  ...
  #
  png(paste('corr_p_sf_t_total_',region_list[region_index],'_lr_pr.png',sep=""),width=8,height=6,units="in",res=500)
  ...
  ##########
  png(paste('corr_res_t_total_',region_list[region_index],'_lr_pr.png',sep=""),width=8,height=6,units="in",res=500)
  ...
  ##########
  png(paste('corr_v_t_total_',region_list[region_index],'_lr_pr.png',sep=""),width=8,height=6,units="in",res=500)
  ...
  #
  png(paste('corr_v_sf_t_total_',region_list[region_index],'_lr_pr.png',sep=""),width=8,height=6,units="in",res=500)
  ...
  ##########
  png(paste('corr_m_t_total_',region_list[region_index],'_lr_pr.png',sep=""),width=8,height=6,units="in",res=500)
  ...
  #
  png(paste('corr_m_sf_t_total_',region_list[region_index],'_lr_pr.png',sep=""),width=8,height=6,units="in",res=500)
  ...
  ##### btm
  png(paste('corr_r_b_total_',region_list[region_index],'_lr_pr.png',sep=""),width=8,height=6,units="in",res=500)
  ...
  ##
  png(paste('corr_r_sf_b_total_',region_list[region_index],'_lr_pr.png',sep=""),width=8,height=6,units="in",res=500)
  ...
  #############
  png(paste('corr_p_b_total_',region_list[region_index],'_lr_pr.png',sep=""),width=8,height=6,units="in",res=500)
  ...
  #
  png(paste('corr_p_sf_b_total_',region_list[region_index],'_lr_pr.png',sep=""),width=8,height=6,units="in",res=500)
  ...
  ##########
  png(paste('corr_res_b_total_',region_list[region_index],'_lr_pr.png',sep=""),width=8,height=6,units="in",res=500)
  ...
  ##########
  png(paste('corr_v_b_total_',region_list[region_index],'_lr_pr.png',sep=""),width=8,height=6,units="in",res=500)
  ...
  #
  png(paste('corr_v_sf_b_total_',region_list[region_index],'_lr_pr.png',sep=""),width=8,height=6,units="in",res=500)
  ...
  ##########
  png(paste('corr_m_b_total_',region_list[region_index],'_lr_pr.png',sep=""),width=8,height=6,units="in",res=500)
  ...
  #
  png(paste('corr_m_sf_b_total_',region_list[region_index],'_lr_pr.png',sep=""),width=8,height=6,units="in",res=500)
