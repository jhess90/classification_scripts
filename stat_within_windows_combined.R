...
#
png(paste('M1_win_wind_sig1.png',sep=""),width=8,height=6,units="in",res=500)
...
#
png(paste('S1_win_wind_sig1.png',sep=""),width=8,height=6,units="in",res=500)
...
png(paste('PmD_win_wind_sig1.png',sep=""),width=8,height=6,units="in",res=500)
...
png(paste('M1_win_wind_sig2.png',sep=""),width=8,height=6,units="in",res=500)
...
plt <- ggplot(diffs.m,aes(variable,value)) + geom_bar(aes(fill=window_labels,group=position),stat='identity',position=position_dodge())
plt <- plt + theme_classic() + labs(title=paste('M1\nTotal Units:',M1_total_unit_num),y='Proportion Significant',x='',fill='Time Window') + theme(axis.text.x = element_text(size = rel(1.3), angle = 00)) + theme(axis.text.y = element_text(size = rel(1.3), angle = 00)) + theme(axis.title.y = element_text(size = rel(1.3), angle = 90))
...
#
png(paste('S1_win_wind_sig2.png',sep=""),width=8,height=6,units="in",res=500)
...
plt <- ggplot(diffs.m,aes(variable,value)) + geom_bar(aes(fill=window_labels,group=position),stat='identity',position=position_dodge())
plt <- plt + theme_classic() + labs(title=paste('S1\nTotal Units:',S1_total_unit_num),y='Proportion Significant',x='',fill='Time Window') + theme(axis.text.x = element_text(size = rel(1.3), angle = 00)) + theme(axis.text.y = element_text(size = rel(1.3), angle = 00)) + theme(axis.title.y = element_text(size = rel(1.3), angle = 90))
plt <- plt + scale_fill_manual(values=c("darkslategray2","darkslategray","darkslategray4"))  + scale_x_discrete(labels=c("R Levels","P Levels","R Outcome","P Outcome","Comb Outcome"))
...
#
png(paste('PmD_win_wind_sig2.png',sep=""),width=8,height=6,units="in",res=500)
...
plt <- ggplot(diffs.m,aes(variable,value)) + geom_bar(aes(fill=window_labels,group=position),stat='identity',position=position_dodge())
plt <- plt + theme_classic() + labs(title=paste('PmD\nTotal Units:',PmD_total_unit_num),y='Proportion Significant',x='',fill='Time Window') + theme(axis.text.x = element_text(size = rel(1.3), angle = 00)) + theme(axis.text.y = element_text(size = rel(1.3), angle = 00)) + theme(axis.title.y = element_text(size = rel(1.3), angle = 90))
plt <- plt + scale_fill_manual(values=c("darkslategray2","darkslategray","darkslategray4"))  + scale_x_discrete(labels=c("R Levels","P Levels","R Outcome","P Outcome","Comb Outcome"))
