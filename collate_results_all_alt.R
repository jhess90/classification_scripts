...
if (nhp_id == '0059'){
  ...
  M1_aft_cue_all_slopes <- readRDS('~/Dropbox/model_alt/avg_ab_z_nl/0_3_13_1/M1_aft_cue_all_slopes_all.rds')
  ...
  M1_aft_cue_all_slopes <- readRDS('~/Dropbox/model_alt/avg_ab_z_nl/5_3_13_1/M1_aft_cue_all_slopes_all.rds')
