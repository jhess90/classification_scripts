...
#1
def div_nl_avg_response_separate_func(x,a,b,c):
        r,p,sum_r,sum_p = x
...
def plot_fr_and_model(unit_num,fr_r_p,params,model_type,region_key,type_key):
        ...
        if model_type == 'linear':
            ...
            z = div_nl_avg_response_together_func([x,y,params[3],params[4]],params[0],params[1],params[2])
        elif model_type == 'div_nl_avg_response_separate':
            z = div_nl_avg_response_separate_func([x,y,params[3],params[4]],params[0],params[1],params[2])
...
def make_div_nl_avg_response_together_model(fr_data_dict,region_key,type_key,file_length,avg_and_corr,total_unit_num):
        ...
        for i in range(file_length):
            ...
            for unit_num in range(avg_fr_data.shape[1]):
                ...
                model_out = div_nl_avg_response_together_func([r_vals,p_vals,avg_fr_by_r,avg_fr_by_p],params[0],params[1],params[2])
...
def make_div_nl_avg_response_separate_model(fr_data_dict,region_key,type_key,file_length,avg_and_corr,total_unit_num):
        ...
        for i in range(file_length):
            ...
            for unit_num in range(avg_fr_data.shape[1]):
                ...
                #
                #all_r_p_responses = [avg_fr_by_r,avg_fr_by_p]
                model_out = div_nl_avg_response_separate_func([r_vals,p_vals,avg_fr_by_r,avg_fr_by_p],params[0],params[1],params[2])
