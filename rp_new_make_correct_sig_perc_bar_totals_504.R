...
attach('~/Dropbox/model_rp/5_8_1/no_abs/alphabeta_M1_percsig_avg.RData')
...
detach()
attach('~/Dropbox/model_rp/5_8_1/no_abs/alphabeta_S1_percsig_avg.RData')
...
detach()
attach('~/Dropbox/model_rp/5_8_1/no_abs/alphabeta_PmD_percsig_avg.RData')
...
attach('~/Dropbox/model_rp/5_8_2/no_abs/alphabeta_M1_percsig_avg.RData')
...
detach()
attach('~/Dropbox/model_rp/5_8_2/no_abs/alphabeta_S1_percsig_avg.RData')
...
detach()
attach('~/Dropbox/model_rp/5_8_2/no_abs/alphabeta_PmD_percsig_avg.RData')
...
attach('~/Dropbox/model_rp/5_9_1/no_abs/alphabeta_M1_percsig_avg.RData')
M1_percsig_bfr_cue_nums_total <- M1_percsig_bfr_cue_nums_total + percsig_bfr_cue_nums
M1_percsig_aft_cue_nums_total <- M1_percsig_aft_cue_nums_total + percsig_aft_cue_nums
M1_percsig_bfr_res_nums_total <- M1_percsig_bfr_res_nums_total + percsig_bfr_res_nums
M1_percsig_aft_res_nums_total <- M1_percsig_aft_res_nums_total + percsig_aft_res_nums
M1_percsig_total_units <- M1_percsig_total_units + percsig_total_units
detach()
attach('~/Dropbox/model_rp/5_9_1/no_abs/alphabeta_S1_percsig_avg.RData')
S1_percsig_bfr_cue_nums_total <- S1_percsig_bfr_cue_nums_total + percsig_bfr_cue_nums
S1_percsig_aft_cue_nums_total <- S1_percsig_aft_cue_nums_total + percsig_aft_cue_nums
S1_percsig_bfr_res_nums_total <- S1_percsig_bfr_res_nums_total + percsig_bfr_res_nums
S1_percsig_aft_res_nums_total <- S1_percsig_aft_res_nums_total + percsig_aft_res_nums
S1_percsig_total_units <- S1_percsig_total_units + percsig_total_units
detach()
attach('~/Dropbox/model_rp/5_9_1/no_abs/alphabeta_PmD_percsig_avg.RData')
PmD_percsig_bfr_cue_nums_total <- PmD_percsig_bfr_cue_nums_total + percsig_bfr_cue_nums
PmD_percsig_aft_cue_nums_total <- PmD_percsig_aft_cue_nums_total + percsig_aft_cue_nums
PmD_percsig_bfr_res_nums_total <- PmD_percsig_bfr_res_nums_total + percsig_bfr_res_nums
PmD_percsig_aft_res_nums_total <- PmD_percsig_aft_res_nums_total + percsig_aft_res_nums
...
attach('~/Dropbox/model_rp/5_9_2/no_abs/alphabeta_M1_percsig_avg.RData')
M1_percsig_bfr_cue_nums_total <- M1_percsig_bfr_cue_nums_total + percsig_bfr_cue_nums
M1_percsig_aft_cue_nums_total <- M1_percsig_aft_cue_nums_total + percsig_aft_cue_nums
M1_percsig_bfr_res_nums_total <- M1_percsig_bfr_res_nums_total + percsig_bfr_res_nums
M1_percsig_aft_res_nums_total <- M1_percsig_aft_res_nums_total + percsig_aft_res_nums
M1_percsig_total_units <- M1_percsig_total_units + percsig_total_units
detach()
attach('~/Dropbox/model_rp/5_9_2/no_abs/alphabeta_S1_percsig_avg.RData')
S1_percsig_bfr_cue_nums_total <- S1_percsig_bfr_cue_nums_total + percsig_bfr_cue_nums
S1_percsig_aft_cue_nums_total <- S1_percsig_aft_cue_nums_total + percsig_aft_cue_nums
S1_percsig_bfr_res_nums_total <- S1_percsig_bfr_res_nums_total + percsig_bfr_res_nums
S1_percsig_aft_res_nums_total <- S1_percsig_aft_res_nums_total + percsig_aft_res_nums
S1_percsig_total_units <- S1_percsig_total_units + percsig_total_units
detach()
attach('~/Dropbox/model_rp/5_9_2/no_abs/alphabeta_PmD_percsig_avg.RData')
PmD_percsig_bfr_cue_nums_total <- PmD_percsig_bfr_cue_nums_total + percsig_bfr_cue_nums
PmD_percsig_aft_cue_nums_total <- PmD_percsig_aft_cue_nums_total + percsig_aft_cue_nums
PmD_percsig_bfr_res_nums_total <- PmD_percsig_bfr_res_nums_total + percsig_bfr_res_nums
PmD_percsig_aft_res_nums_total <- PmD_percsig_aft_res_nums_total + percsig_aft_res_nums
...
attach('~/Dropbox/model_rp/5_14_1/no_abs/alphabeta_M1_percsig_avg.RData')
M1_percsig_bfr_cue_nums_total <- M1_percsig_bfr_cue_nums_total + percsig_bfr_cue_nums
M1_percsig_aft_cue_nums_total <- M1_percsig_aft_cue_nums_total + percsig_aft_cue_nums
M1_percsig_bfr_res_nums_total <- M1_percsig_bfr_res_nums_total + percsig_bfr_res_nums
M1_percsig_aft_res_nums_total <- M1_percsig_aft_res_nums_total + percsig_aft_res_nums
M1_percsig_total_units <- M1_percsig_total_units + percsig_total_units
detach()
attach('~/Dropbox/model_rp/5_14_1/no_abs/alphabeta_S1_percsig_avg.RData')
S1_percsig_bfr_cue_nums_total <- S1_percsig_bfr_cue_nums_total + percsig_bfr_cue_nums
S1_percsig_aft_cue_nums_total <- S1_percsig_aft_cue_nums_total + percsig_aft_cue_nums
S1_percsig_bfr_res_nums_total <- S1_percsig_bfr_res_nums_total + percsig_bfr_res_nums
S1_percsig_aft_res_nums_total <- S1_percsig_aft_res_nums_total + percsig_aft_res_nums
S1_percsig_total_units <- S1_percsig_total_units + percsig_total_units
detach()
attach('~/Dropbox/model_rp/5_14_1/no_abs/alphabeta_PmD_percsig_avg.RData')
PmD_percsig_bfr_cue_nums_total <- PmD_percsig_bfr_cue_nums_total + percsig_bfr_cue_nums
PmD_percsig_aft_cue_nums_total <- PmD_percsig_aft_cue_nums_total + percsig_aft_cue_nums
PmD_percsig_bfr_res_nums_total <- PmD_percsig_bfr_res_nums_total + percsig_bfr_res_nums
PmD_percsig_aft_res_nums_total <- PmD_percsig_aft_res_nums_total + percsig_aft_res_nums
...
attach('~/Dropbox/model_rp/5_14_2/no_abs/alphabeta_M1_percsig_avg.RData')
M1_percsig_bfr_cue_nums_total <- M1_percsig_bfr_cue_nums_total + percsig_bfr_cue_nums
M1_percsig_aft_cue_nums_total <- M1_percsig_aft_cue_nums_total + percsig_aft_cue_nums
M1_percsig_bfr_res_nums_total <- M1_percsig_bfr_res_nums_total + percsig_bfr_res_nums
M1_percsig_aft_res_nums_total <- M1_percsig_aft_res_nums_total + percsig_aft_res_nums
M1_percsig_total_units <- M1_percsig_total_units + percsig_total_units
detach()
attach('~/Dropbox/model_rp/5_14_2/no_abs/alphabeta_S1_percsig_avg.RData')
S1_percsig_bfr_cue_nums_total <- S1_percsig_bfr_cue_nums_total + percsig_bfr_cue_nums
S1_percsig_aft_cue_nums_total <- S1_percsig_aft_cue_nums_total + percsig_aft_cue_nums
S1_percsig_bfr_res_nums_total <- S1_percsig_bfr_res_nums_total + percsig_bfr_res_nums
S1_percsig_aft_res_nums_total <- S1_percsig_aft_res_nums_total + percsig_aft_res_nums
S1_percsig_total_units <- S1_percsig_total_units + percsig_total_units
detach()
attach('~/Dropbox/model_rp/5_14_2/no_abs/alphabeta_PmD_percsig_avg.RData')
PmD_percsig_bfr_cue_nums_total <- PmD_percsig_bfr_cue_nums_total + percsig_bfr_cue_nums
PmD_percsig_aft_cue_nums_total <- PmD_percsig_aft_cue_nums_total + percsig_aft_cue_nums
PmD_percsig_bfr_res_nums_total <- PmD_percsig_bfr_res_nums_total + percsig_bfr_res_nums
PmD_percsig_aft_res_nums_total <- PmD_percsig_aft_res_nums_total + percsig_aft_res_nums
...
attach('~/Dropbox/model_rp/5_14_3/no_abs/alphabeta_M1_percsig_avg.RData')
M1_percsig_bfr_cue_nums_total <- M1_percsig_bfr_cue_nums_total + percsig_bfr_cue_nums
M1_percsig_aft_cue_nums_total <- M1_percsig_aft_cue_nums_total + percsig_aft_cue_nums
M1_percsig_bfr_res_nums_total <- M1_percsig_bfr_res_nums_total + percsig_bfr_res_nums
M1_percsig_aft_res_nums_total <- M1_percsig_aft_res_nums_total + percsig_aft_res_nums
M1_percsig_total_units <- M1_percsig_total_units + percsig_total_units
detach()
attach('~/Dropbox/model_rp/5_14_3/no_abs/alphabeta_S1_percsig_avg.RData')
S1_percsig_bfr_cue_nums_total <- S1_percsig_bfr_cue_nums_total + percsig_bfr_cue_nums
S1_percsig_aft_cue_nums_total <- S1_percsig_aft_cue_nums_total + percsig_aft_cue_nums
S1_percsig_bfr_res_nums_total <- S1_percsig_bfr_res_nums_total + percsig_bfr_res_nums
S1_percsig_aft_res_nums_total <- S1_percsig_aft_res_nums_total + percsig_aft_res_nums
S1_percsig_total_units <- S1_percsig_total_units + percsig_total_units
detach()
attach('~/Dropbox/model_rp/5_14_3/no_abs/alphabeta_PmD_percsig_avg.RData')
PmD_percsig_bfr_cue_nums_total <- PmD_percsig_bfr_cue_nums_total + percsig_bfr_cue_nums
PmD_percsig_aft_cue_nums_total <- PmD_percsig_aft_cue_nums_total + percsig_aft_cue_nums
PmD_percsig_bfr_res_nums_total <- PmD_percsig_bfr_res_nums_total + percsig_bfr_res_nums
PmD_percsig_aft_res_nums_total <- PmD_percsig_aft_res_nums_total + percsig_aft_res_nums
...
for (region_index in 1:length(region_list)){
  ...
  labs <- c('no sig','both sig','beta only sig','alpha only sig')
  ...
  bfr_cue_df <- ddply(bfr_cue_df,.(type),transform,label=paste(scales::percent(bfr_cue_df$perc),' n=',percsig_bfr_cue_nums,sep=""))
  aft_cue_df <- ddply(aft_cue_df,.(type),transform,label=paste(scales::percent(aft_cue_df$perc),' n=',percsig_aft_cue_nums,sep=""))
  bfr_res_df <- ddply(bfr_res_df,.(type),transform,label=paste(scales::percent(bfr_res_df$perc),' n=',percsig_bfr_res_nums,sep=""))
  aft_res_df <- ddply(aft_res_df,.(type),transform,label=paste(scales::percent(aft_res_df$perc),' n=',percsig_aft_res_nums,sep=""))
