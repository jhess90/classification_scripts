...
for region_key,region_value in data.iteritems():
        ...
        for comb_key,comb_val in sig_data[0].iteritems():
			...
			plt.xticks(my_ticks_num,my_ticks)
                ...
                plt.savefig('sigplt_m_%s_%s_1' %(region_key,comb_key))
                plt.clf()
        ...
        for comb_key,comb_val in sig_data[0].iteritems():
			...
			plt.xticks(my_ticks_num,my_ticks)
                ...
                plt.subplots_adjust(top=0.9)
                plt.suptitle('Region: %s, combination: %s' %(region_key,comb_key))
                plt.savefig('sigplt_m_%s_%s_2' %(region_key,comb_key))
                plt.clf()
        ...
        for comb_key,comb_val in sig_data[0].iteritems():
			...
			plt.xticks(my_ticks_num,my_ticks)
                ...
                plt.subplots_adjust(top=0.9)
                plt.suptitle('Region: %s, combination: %s' %(region_key,comb_key))
                plt.savefig('sigplt_m_%s_%s_3' %(region_key,comb_key))
                plt.clf()
        ...
        for comb_key,comb_val in sig_data[0].iteritems():
			...
			plt.xticks(my_ticks_num,my_ticks)
                ...
                plt.subplots_adjust(top=0.9)
                plt.suptitle('Region: %s, combination: %s' %(region_key,comb_key))
                plt.savefig('sigplt_m_%s_%s_4' %(region_key,comb_key))
                plt.clf()
