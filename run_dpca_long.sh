...
Rscript ~/classification_scripts/dpca_plot_analysis_nod.R
...
python /home/jack/classfiication_scripts/analyze_dpca_nod.py
Rscript ~/classficiation_scripts/dpca_plot_analysis_nod.R
