...
#
#cd ../
#mkdir play_r_p_lin_diff r_p_pop_response
...
mv Extracted* ../play_avg_noz/
cd ../play_avg_noz/
python /home/jack/workspace/classification_scripts/combine_and_model_play_avgs_noz_plot.py
mv Extracted* ../
...
mv Extracted* ../play/
cd ../play/
python /home/jack/workspace/classification_scripts/combine_and_model_play_plot.py
mv Extracted* ../play_r_p_only/
cd ../play_r_p_only/
python /home/jack/workspace/classification_scripts/combine_and_model_play_r_p_only_plot.py
mv Extracted* ../play_avg/
cd ../play_avg/
python /home/jack/workspace/classification_scripts/combine_and_model_play_avgs_plot.py
mv Extracted* ../
