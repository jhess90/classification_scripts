...
for(region_index in 1:length(region_list)){
  ...
  for (unit_num in 1:dim(all_cue_fr)[1]){
    ...
    r_cue_avgs <- data.frame(time=time,r0=rollmean(colMeans(all_cue_fr[unit_num,r0,]),5),r1=rollmean(colMeans(all_cue_fr[unit_num,r1,]),5))
    r_res_avgs <- data.frame(time=time,r0=rollmean(colMeans(all_res_fr[unit_num,r0,]),5),r1=rollmean(colMeans(all_res_fr[unit_num,r1,]),5))
    ...
    p_cue_avgs <- data.frame(time=time,p0=rollmean(colMeans(all_cue_fr[unit_num,p0,]),5),p1=rollmean(colMeans(all_cue_fr[unit_num,p1,]),5))
    p_res_avgs <- data.frame(time=time,p0=rollmean(colMeans(all_res_fr[unit_num,p0,]),5),p1=rollmean(colMeans(all_res_fr[unit_num,p1,]),5))
    ...
    v_cue_avgs <- data.frame(time=time,v_1=rollmean(colMeans(all_cue_fr[unit_num,v_1,]),5),v0=rollmean(colMeans(all_cue_fr[unit_num,v0,]),5),v1=rollmean(colMeans(all_cue_fr[unit_num,v1,]),5))
    v_res_avgs <- data.frame(time=time,v_1=rollmean(colMeans(all_res_fr[unit_num,v_1,]),5),v0=rollmean(colMeans(all_res_fr[unit_num,v0,]),5),v1=rollmean(colMeans(all_res_fr[unit_num,v1,]),5))
    ...
    m_cue_avgs <- data.frame(time=time,m0=rollmean(colMeans(all_cue_fr[unit_num,m0,]),5),m1=rollmean(colMeans(all_cue_fr[unit_num,m1,]),5),m2=rollmean(colMeans(all_cue_fr[unit_num,m2,]),5))
    m_res_avgs <- data.frame(time=time,m0=rollmean(colMeans(all_res_fr[unit_num,m0,]),5),m1=rollmean(colMeans(all_res_fr[unit_num,m1,]),5),m2=rollmean(colMeans(all_res_fr[unit_num,m2,]),5))
    ...
    #r_res_succ_avgs <- data.frame(time=time,r0_succ=rollmean(colMeans(all_res_fr[unit_num,r0_succ,]),5),r1_succ=rollmean(colMeans(all_res_fr[unit_num,r1_succ,]),5),r2_succ=rollmean(colMeans(all_res_fr[unit_num,r2_succ,]),5),r1_succ=rollmean(colMeans(all_res_fr[unit_num,r1_succ,]),5))
    #r_res_fail_avgs <- data.frame(time=time,r0_fail=r0_fail_avg,r1_fail=r1_fail_avg,r2_fail=r2_fail_avg,r1_fail=r1_fail_avg)
    
    #r_res_succ_avgs <- data.frame(time=time,r0=rollmean(colMeans(all_res_fr[unit_num,r0_succ,]),5),r1=rollmean(colMeans(all_res_fr[unit_num,r1_succ,]),5),r2=rollmean(colMeans(all_res_fr[unit_num,r2_succ,]),5),r1=rollmean(colMeans(all_res_fr[unit_num,r1_succ,]),5))
    #r_res_fail_avgs <- data.frame(time=time,r0=r0_fail_avg,r1=r1_fail_avg,r2=r2_fail_avg,r1=r1_fail_avg)
