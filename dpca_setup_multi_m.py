...
def sort_and_avg(fr_array,sort_dict):
	...
	for i in range(I):
                if run_motiv:
                        if i == 0:
                                ...
                                i_trials = sort_dict['index']['m3']
                        elif i == 4:
                                i_trials = sort_dict['index']['m4']
                        elif i == 5:
                                i_trials = sort_dict['index']['m5']
                        elif i == 6:
                                i_trials = sort_dict['index']['m6']

                elif run_value:
                        if i == 0:
                                i_trials = sort_dict['index']['v_3']
                        elif i == 1:
                                i_trials = sort_dict['index']['v_2']
                        elif i == 2:
                                ...
                                i_trials = sort_dict['index']['v2']
                        elif i == 6:
                                i_trials = sort_dict['index']['v3']
	...
	bal_fr_shaped[:,:,3,0,:] = fr_array[bal_ind[6,:].astype(int),:,:]
	bal_fr_shaped[:,:,3,1,:] = fr_array[bal_ind[7,:].astype(int),:,:]
	bal_fr_shaped[:,:,4,0,:] = fr_array[bal_ind[8,:].astype(int),:,:]
	bal_fr_shaped[:,:,4,1,:] = fr_array[bal_ind[9,:].astype(int),:,:]
	bal_fr_shaped[:,:,5,0,:] = fr_array[bal_ind[10,:].astype(int),:,:]
	bal_fr_shaped[:,:,5,1,:] = fr_array[bal_ind[11,:].astype(int),:,:]
	bal_fr_shaped[:,:,6,0,:] = fr_array[bal_ind[12,:].astype(int),:,:]
	bal_fr_shaped[:,:,6,1,:] = fr_array[bal_ind[13,:].astype(int),:,:]
...
for i in range(np.shape(condensed)[0]):
	if condensed[i,3] == 0 and condensed[i,4] == 0:
		m0.append(i)
                v0.append(i)
        elif condensed[i,3] == 1 and condensed[i,4] == 0:
                m1.append(i)
                v1.append(i)
        elif condensed[i,3] == 2 and condensed[i,4] == 0:
                m2.append(i)
                v2.append(i)
        ...
        elif condensed[i,3] == 0 and condensed[i,4] == 1:
                m1.append(i)
                v_1.append(i)
        elif condensed[i,3] == 1 and condensed[i,4] == 1:
                m2.append(i)
                v0.append(i)
        elif condensed[i,3] == 2 and condensed[i,4] == 1:
                m3.append(i)
                v1.append(i)
        elif condensed[i,3] == 3 and condensed[i,4] == 1:
                m4.append(i)
                v2.append(i)

        elif condensed[i,3] == 0 and condensed[i,4] == 2:
                m2.append(i)
                v_2.append(i)
        elif condensed[i,3] == 1 and condensed[i,4] == 2:
                m3.append(i)
                v_1.append(i)
        elif condensed[i,3] == 2 and condensed[i,4] == 2:
                m4.append(i)
                v0.append(i)
        elif condensed[i,3] == 3 and condensed[i,4] == 2:
                m5.append(i)
                v1.append(i)
                ...
                m4.append(i)
                v_3.append(i)
        elif condensed[i,3] == 1 and condensed[i,4] == 3:
                m4.append(i)
                v_2.append(i)
        elif condensed[i,3] == 2 and condensed[i,4] == 3:
                m5.append(i)
                v_1.append(i)
...
m_stim = {'m0':m0,'m1':m1,'m2':m2,'m3':m3,'m4':m4,'m5':m5,'m6':m6}
v_stim = {'v_3':v_3,'v_2':v_2,'v_1':v_1,'v0':v0,'v1':v1,'v2':v2,'v3':v3}
...
for region_key,region_val in all_dict.iteritems():
    ...
    if run_motiv:
            labels = ['m0_f','m0_s','m1_f','m1_s','m2_f','m2_s','m3_f','m3_s','m4_f','m4_s','m5_f','m5_s','m6_f','m6_s']
    elif run_value:
            labels = ['v_3_f','v_3_s','v_2_f','v_2_s','v_1_f','v_1_s','v0_f','v0_s','v1_f','v1_s','v2_f','v2_s','v3_f','v3_s']

    colors = ['indigo','indigo','blue','blue','steelblue','steelblue','g','g','gold','gold','darkorange','darkorange','crimson','crimson']
