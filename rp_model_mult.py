...
#adding mult and val
condensed_new = np.zeros((np.shape(condensed)[0],8))
condensed_new[:,0:6] = condensed
condensed_new[:,6] = condensed[:,3] - condensed[:,4] #value vector
condensed_new[:,7] = condensed[:,3] + condensed[:,4] #motivation vector
...
for region_key,region_value in data_dict_all.iteritems():
        ...
        temp_stacked = plot_stacked_avgs(bfr_cue_model,aft_cue_model,bfr_result_model,aft_result_model,bfr_cue,aft_cue,bfr_result,aft_result,condensed,region_key,'all_stacked')
