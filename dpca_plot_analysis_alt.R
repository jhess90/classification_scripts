...
PmD_total <- as.numeric(all_data$X17[10])
S1_total <- as.numeric(all_data$X33[10])
M1_total <- as.numeric(all_data$X49[10])
...
percs.melt$X1 <- factor(percs.melt$X1,c("t","rt","pt","dt","rpt","rdt","pdt","rpdt"))
