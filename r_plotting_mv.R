...
for(region_index in 1:length(file_list)){
  ...
  for (j in 1:num_sheets){
    ...
    df_val_all_cue <- melt(df_val_all_cue,id.vars="time",variable_name="vals")
    ...
    df_val_succ_result <- melt(df_val_succ_result,id.vars="time",variable_name="vals")
    plt_val_succ_result <- ggplot(df_val_succ_result, aes(time,value)) + geom_line(aes(colour=vals),size=1.5)
    ...
    df_val_fail_result <- melt(df_val_fail_result,id.vars="time",variable_name="vals")
    plt_val_fail_result <- ggplot(df_val_fail_result, aes(time,value)) + geom_line(aes(colour=vals),size=1.5)
    ...
    df_mtv_all_cue <- melt(df_mtv_all_cue,id.vars="time",variable_name="vals")
    plt_mtv_all_cue <- ggplot(df_mtv_all_cue, aes(time,value)) + geom_line(aes(colour=vals),size=1.5)
    ...
    df_mtv_succ_result <- melt(df_mtv_succ_result,id.vars="time",variable_name="vals")
    plt_mtv_succ_result <- ggplot(df_mtv_succ_result, aes(time,value)) + geom_line(aes(colour=vals),size=1.5)
    ...
    df_mtv_fail_result <- melt(df_mtv_fail_result,id.vars="time",variable_name="vals")
    plt_mtv_fail_result <- ggplot(df_mtv_fail_result, aes(time,value)) + geom_line(aes(colour=vals),size=1.5)
