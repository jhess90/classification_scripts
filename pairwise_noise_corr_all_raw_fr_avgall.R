...
compute_plot_corr <- function(all_cue_fr_M1,all_cue_fr_S1,all_cue_fr_PmD,all_res_fr_M1,all_res_fr_S1,all_res_fr_PmD,total_unit_num_M1,total_unit_num_S1,total_unit_num_PmD,type_name,trial_inds){
  ...
  write.table(cue_sum_label_df,paste('raw_noise_',type_name,'_avgall_cue.txt',sep=""),sep="\t",row.names=FALSE)
  write.table(res_sum_label_df,paste('raw_noise_',type_name,'_avgall_res.txt',sep=""),sep="\t",row.names=FALSE)
  
  #plot correlation matrix
  png(paste("raw_noise_corr_spear_all_avgall_",type_name,".png",sep=""),width=8,height=6,units="in",res=500)
  ...
  #plot correlation matrix
  png(paste("raw_noise_corr_spear_all_no_txt_avgall_",type_name,".png",sep=""),width=8,height=6,units="in",res=500)
