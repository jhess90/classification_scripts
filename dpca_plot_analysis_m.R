...
all_data <- read.xlsx('perc_variance_m.xlsx',sheet=1,colNames=T)
...
png('explained_variance_m.png',width=8,height=6,units="in",res=500)
plot(total_perc_plt) 
...
png('explained_variance_variables_m.png',width=8,height=6,units="in",res=500)

percs.melt$X1 <- factor(percs.melt$X1,c("t","it","dt","idt"))
