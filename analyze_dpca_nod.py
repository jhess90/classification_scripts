...
print 'organizing explained variance'
...
try:
        ...
        explained_var = np.load('dpca_results_binaryrp_nod_S1_explained_var.npy')[()]
        sig_analysis = np.load('dpca_results_binaryrp_nod_S1_sig_analysis.npy')[()]
        data['S1'] = {}
