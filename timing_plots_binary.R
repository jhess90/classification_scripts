...
#punishment
png("time_punishment_binary.png",width=8,height=6,units="in",res=500)
...
#value
png("time_value_binary.png",width=8,height=6,units="in",res=500)
...
#motivation
png("time_motivation_binary.png",width=8,height=6,units="in",res=500)
...
#reward sf
png("time_reward_sf_binary.png",width=8,height=6,units="in",res=500)
...
#punishment sf
png("time_punishment_sf_binary.png",width=8,height=6,units="in",res=500)
