...
for region_key,region_val in data_dict_all.iteritems():
    ...
    for win_key,win_val in data_dict_all[region_key]['avg_and_corr'].iteritems():
        ...
        axarr[0].scatter(chance2_all_4[srt],range(np.shape(chance2_all_4)[0]),color='indianred',marker="|",linewidth=0.4,alpha=0.9)
        ...
        axarr[1].scatter(chance2_all_4[srt2],range(np.shape(chance2_all_4)[0]),color='indianred',marker="|",linewidth=0.4,alpha=0.9)
        ...
        axarr[0].scatter(chance2_all_2[srt],range(np.shape(chance2_all_2)[0]),color='indianred',marker="|",linewidth=0.4,alpha=0.9)
        axarr[0].set_ylim([-2,np.shape(chance2_all_4)[0]+2])
        axarr[0].yaxis.set_major_locator(plt.MaxNLocator(3))
        ...
        axarr[1].scatter(chance2_all_2[srt2],range(np.shape(chance2_all_2)[0]),color='indianred',marker="|",linewidth=0.4,alpha=0.9)
        axarr[1].set_ylim([-2,np.shape(chance2_all_4)[0]+2])
        axarr[1].yaxis.set_major_locator(plt.MaxNLocator(3))
