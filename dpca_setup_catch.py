...
def sort_and_avg(fr_array,sort_dict):
				...
				if q == 0:
					...
					q_trials = sort_dict['q_result']['succ_trials']
                                ...
                                for c in range(C):
                                        ...
                                        combined = ()
                                        for k in range(K):
                                                if k in r_trials and k in p_trials and k in q_trials and c in c_trials:
	...
	bal_fr_shaped = np.zeros((min_trial_size,N,R,P,Q,C,T))
	...
	bal_fr_shaped[:,:,0,0,0,0,:] = fr_array[bal_ind[0,:].astype(int),:,:]
	bal_fr_shaped[:,:,0,0,0,1,:] = fr_array[bal_ind[1,:].astype(int),:,:]
	bal_fr_shaped[:,:,0,0,0,2,:] = fr_array[bal_ind[2,:].astype(int),:,:]
	bal_fr_shaped[:,:,0,0,1,0,:] = fr_array[bal_ind[3,:].astype(int),:,:]
	bal_fr_shaped[:,:,0,0,1,1,:] = fr_array[bal_ind[4,:].astype(int),:,:]
	bal_fr_shaped[:,:,0,0,1,2,:] = fr_array[bal_ind[5,:].astype(int),:,:]
	bal_fr_shaped[:,:,0,1,0,0,:] = fr_array[bal_ind[6,:].astype(int),:,:]
	bal_fr_shaped[:,:,0,1,0,1,:] = fr_array[bal_ind[7,:].astype(int),:,:]
	bal_fr_shaped[:,:,0,1,0,2,:] = fr_array[bal_ind[8,:].astype(int),:,:]
	bal_fr_shaped[:,:,0,1,1,0,:] = fr_array[bal_ind[9,:].astype(int),:,:]
	bal_fr_shaped[:,:,0,1,1,1,:] = fr_array[bal_ind[10,:].astype(int),:,:]
	bal_fr_shaped[:,:,0,1,1,2,:] = fr_array[bal_ind[11,:].astype(int),:,:]
	bal_fr_shaped[:,:,1,0,0,0,:] = fr_array[bal_ind[12,:].astype(int),:,:]
	bal_fr_shaped[:,:,1,0,0,1,:] = fr_array[bal_ind[13,:].astype(int),:,:]
	bal_fr_shaped[:,:,1,0,0,2,:] = fr_array[bal_ind[14,:].astype(int),:,:]
	bal_fr_shaped[:,:,1,0,1,0,:] = fr_array[bal_ind[15,:].astype(int),:,:]
	bal_fr_shaped[:,:,1,0,1,1,:] = fr_array[bal_ind[16,:].astype(int),:,:]
	bal_fr_shaped[:,:,1,0,1,2,:] = fr_array[bal_ind[17,:].astype(int),:,:]
	bal_fr_shaped[:,:,1,1,0,0,:] = fr_array[bal_ind[18,:].astype(int),:,:]
	bal_fr_shaped[:,:,1,1,0,1,:] = fr_array[bal_ind[19,:].astype(int),:,:]
	bal_fr_shaped[:,:,1,1,0,2,:] = fr_array[bal_ind[20,:].astype(int),:,:]
	bal_fr_shaped[:,:,1,1,1,0,:] = fr_array[bal_ind[21,:].astype(int),:,:]
	bal_fr_shaped[:,:,1,1,1,1,:] = fr_array[bal_ind[22,:].astype(int),:,:]
	bal_fr_shaped[:,:,1,1,1,2,:] = fr_array[bal_ind[23,:].astype(int),:,:]
